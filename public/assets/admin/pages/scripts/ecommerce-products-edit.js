            ...
            init: {
                ...
                FileUploaded: function(up, file, response) {
                    ...
                    if (response.result && response.result == 'OK') {
                        ...
                        $('#picsbody').append('<tr><td  class="hidden"><input type="text" name="pid" value='+response.pic.id+' /></td>'
                        +'<td><a href='+response.filePath+' class="fancybox-button" data-rel="fancybox-button"><img class="img-responsive" src="'+response.filePath+'?imageMogr2/thumbnail/91x" alt=""></a></td>'
                        +'<td><input type="text" class="form-control" name="sku" value="" placeholder="大瓶装300ml or xL 红色"></td>'
                        +'<td><input type="text" class="form-control" name="price" value="" placeholder=""></td>'
                        +'<td><input type="text" class="form-control" name="market" value="" placeholder=""></td>'
                        +'<td><input type="text" class="form-control" name="amount"  placeholder=""></td>'
                        +'<td><input type="text" class="form-control" name="heavy" placeholder="" value="'+response.pic.heavy+'"></td>'
                        +'<td><a href="javascript:;" data-id='+response.pic.id+' class="del btn default btn-sm"><i class="fa fa-times"></i> Remove </a></td></tr>')
                        d()
                    } else {
